...
| spec-1.7 | **frozen · 实施中**（LiteLLM 无状态纯路由 + 配额/用量平台侧；起草前实测 LiteLLM 1.96.2：无 DB 可跑、Responses 桥接依赖供应商原生前缀、/metrics 需 key、成功路径日志无 prompt；新增第三方镜像依赖一并批准）| 2026-08-15 起草并 approve |
