...
| Spec | 状态 | 日期 |
|---|---|---|
| spec-0.1 | DRAFT · **已实施**（T1-T5 全过，Mac 宿主机验证） | 2026-08-08 起草；08-10 实施完成 |
...
| spec-0.11 | DRAFT · **已实施**（T1-T7 过；v0.0.1-rc.1 全链路实弹演练成功） | 2026-08-09 起草；08-10 实施完成 |
| spec-0.12 | DRAFT · **验收中**（自动项 6/7→修 A7 后全过，待 user 签署） | 2026-08-09 起草；08-10 验收执行 |
