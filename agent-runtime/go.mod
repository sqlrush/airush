...
require (
	...
	github.com/sqlrush/airush/console v0.0.0
	...
	github.com/sqlrush/airush/libs/llm v0.0.0-00010101000000-000000000000
	...
	github.com/sqlrush/airush/testkit v0.0.0
	github.com/sqlrush/codexgo v0.0.0-00010101000000-000000000000
)
...
// codexgo 抽核分支 airush-core（spec-1.8 §8 Q1 ★A）：本地 ../../codexgo，CI 二次 checkout 到同一相对路径。
replace github.com/sqlrush/codexgo => ../../codexgo
...
replace github.com/sqlrush/airush/console => ../console

replace github.com/sqlrush/airush/libs/obs => ../libs/obs

replace github.com/sqlrush/airush/libs/llm => ../libs/llm
